 ...
 * Phase 1 data (pairs) + Phase 2 data (corrections) + Phase 3 data (test requests)
 */
...
I submitted my application for the Product Manager role (Job ID: PM-2024-12) two weeks ago and wanted to check on its status.

Since applying, I've also shipped a feature at my current role that reduced onboarding churn by 18% — happy to share details if relevant to the team's current priorities.
...
[Your Name]`,
  },
  {
    ...
    request: "Decline a meeting invite for a cross-team sync because I have a conflicting product review.",
    aiDraft: `Dear [Organizer's Name],

Thank you so much for including me in the cross-team sync meeting. Unfortunately, I regret to inform you that I will not be able to attend as I have a conflicting product review meeting that was previously scheduled at the same time. I sincerely apologize for any inconvenience this may cause, and I feel terrible about not being able to participate. I value the collaboration between our teams and I want to assure you that I remain committed to staying aligned on our shared initiatives. If there are any materials or notes from the meeting that I could review afterward, I would be very grateful. Alternatively, if the meeting is rescheduled to a different time, I would be more than happy to attend. Please do not hesitate to reach out if there is anything I can contribute in advance.

With sincere apologies,
[Your Name]`,
    userEdit: `Hi [Organizer's Name],

I have a product review at the same time so I can't make this one. Could you share notes after? If there's anything you need input on from my side beforehand, happy to async in the project doc.
...
const corrections = [
  ...
  },
  {
    ...
    pairId: "professor-2",
    context: "professor",
    rule: "When making a request of a professor, front-load the specific details they need to decide (course name, grade, project, deadline) instead of generic flattery about enjoying their class.",
    avoid: [
      "I have really enjoyed your classes",
      "I feel that I have learned a great deal from you",
      "I believe that your perspective on my academic abilities would be very valuable",
      "at your earliest convenience",
    ],
    prefer: [
      "Name the specific program type and deadline",
      "Reference specific courses with semester and grade: 'Molecular Systems course (Spring '25, A)'",
      "List what you'll provide: 'I can send you my CV, statement of purpose, and a list of programs'",
    ],
    evidence: {
      before: "I have really enjoyed your classes and feel that I have learned a great deal from you. I believe that your perspective on my academic abilities would be very valuable for my applications.",
      after: "I took your Molecular Systems course (Spring '25, A) and worked on the protein folding project in your lab last summer.",
    },
  },
  {
    ...
    pairId: "professor-3",
    context: "professor",
    rule: "For simple scheduling requests, state the conflict, propose 2-3 specific alternative times, and mention the topic in one line — total message should be under 5 sentences.",
    avoid: [
      "I hope this message finds you well",
      "I understand that you are very busy",
      "I apologize for the inconvenience of requesting a schedule change",
      "Any time that works for you would be greatly appreciated",
    ],
    prefer: [
      "Offer specific alternative slots: 'I'm free Monday after 2 or Thursday morning'",
      "Mention the topic briefly: 'I have questions about the Ch. 7 material'",
      "Use 'I have a conflict' without elaborating on the reason",
    ],
    evidence: {
      before: "I wanted to reach out to you regarding your office hours this week. Unfortunately, I have a previously scheduled doctor's appointment that conflicts with your regular office hours time. I have been meaning to come see you to discuss some questions I have about the recent lecture material, specifically regarding the concepts covered in Chapter 7. I was wondering if there might be any possibility of meeting at an alternative time this week.",
  ...
  },
  {
    ...
    pairId: "friend-2",
    context: "friend",
    rule: "When recommending something to a friend, convey your personal reaction viscerally ('my brain is broken') and use a punchy comparison they'd get — don't list generic review qualities like 'the acting is excellent'.",
    avoid: [
      "It's a really interesting show",
      "The premise is quite unique and the acting is excellent",
      "The plot keeps you engaged throughout",
      "I would highly recommend giving it a try when you have some free time",
    ],
    prefer: [
      "Urgent, imperative tone: 'you NEED to watch'",
      "Personal visceral reaction: 'my brain is broken'",
      "A relatable comparison: 'like if The Office was a psychological thriller'",
      "Direct instruction: 'don't look anything up, just go in blind. trust me.'",
    ],
    evidence: {
      before: "It's a really interesting show that I think you would enjoy. The premise is quite unique and the acting is excellent. The plot keeps you engaged throughout and there are many surprising twists.",
      after: "I just binged the whole thing and my brain is broken. it's like if The Office was a psychological thriller?? don't look anything up, just go in blind. trust me.",
    },
  },
  {
    ...
    pairId: "friend-3",
    context: "friend",
    rule: "For favors between friends, ask directly in the first sentence, state the logistics (when, how long), name the bribe, and add a genuine no-pressure out — don't hedge with 'I was wondering if you might be available'.",
    avoid: [
      "I have a bit of a favor to ask",
      "I was wondering if you might be available",
      "I understand this is a big ask and I completely understand if you have other commitments",
      "Please let me know if this is something you'd be able to do",
    ],
    prefer: [
      "Direct question opener: 'are you free next saturday?'",
      "Name the bribe upfront: 'I'll bribe you with pizza and beer obviously'",
      "Casual no-pressure closer: 'No pressure if you can't tho!'",
    ],
    evidence: {
  ...
  },
  {
    ...
    context: "professional",
    rule: "In a follow-up email, reference the specific job ID, skip the enthusiasm declarations, and add a new concrete data point (a recent accomplishment with a metric) that wasn't in the original application — give them a reason to re-engage.",
    avoid: [
      "I remain very enthusiastic about this opportunity",
      "I wanted to reiterate my strong interest",
      "I believe my background in product development and my experience with agile methodologies make me a strong candidate",
      "I understand that the hiring process can take time",
    ],
    prefer: [
      "Reference the job ID: 'Product Manager role (Job ID: PM-2024-12)'",
      "Add a new data point with a metric: 'shipped a feature that reduced onboarding churn by 18%'",
      "Close with a specific question: 'Is there a timeline for next steps?'",
    ],
    evidence: {
      before: "I remain very enthusiastic about this opportunity and I wanted to reiterate my strong interest in the role. I believe my background in product development and my experience with agile methodologies make me a strong candidate for this position.",
      after: "Since applying, I've also shipped a feature at my current role that reduced onboarding churn by 18% — happy to share details if relevant to the team's current priorities.",
    },
  },
  {
    ...
    context: "professional",
    rule: "For PTO requests, state the dates and reason in one sentence, proactively name who will cover your work, and end with a specific action item for the manager (e.g., 'approve in Workday') — don't justify the reason for taking time off.",
    avoid: [
      "I am writing to respectfully request some time off",
      "The wedding celebration spans several days as it is a traditional ceremony with multiple events",
      "I want to assure you that I will make every effort",
      "I hope this won't cause too much inconvenience",
    ],
    prefer: [
      "Compact date format: 'PTO on Oct 15–17'",
      "Name the coverage person: 'sprint items are handed off to Sarah'",
      "Specific action request: 'Could you approve this in Workday when you get a chance?'",
      "Brief availability note: 'I'll be reachable for anything urgent'",
    ],
    evidence: {
      before: "My cousin is getting married next month, and the wedding celebration spans several days as it is a traditional ceremony with multiple events. The wedding is taking place out of state, so I will also need travel time. I would like to request three days of paid time off: October 15th, 16th, and 17th. I want to assure you that I will make every effort to complete all pending work before my absence and ensure a smooth handoff of any ongoing projects.",
      after: "I'd like to take PTO on Oct 15-17 for a family wedding. I'll make sure the sprint items are handed off to Sarah before I go and I'll be reachable for anything urgent.",
    },
  },
  {
...
// Phase 3: Transfer test requests (one per context, different scenario from training)
const transferTests = [
  {
    context: "professor",
...
module.exports = { trainingPairs, corrections, transferTests };
